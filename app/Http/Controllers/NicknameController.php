...
class NicknameController extends Controller
{
    ...
    {
        $name1 = array ('封印されし' , '解き放たれし' , '蘇りし' , '眠れる' , '知られざる', 'とらわれし' , '世界を統べる' , '闇に生きる', '悲しみを知った' , '孤独なる' , '邪悪なる' , '呪われし', '空中を漂う' , 'オーラをまとった' , '覚醒した', '邪気に満ちた', '降臨した', '選ばれし', '十字架を背負った', '残業に苦しむ',);
        $name2 = array ('暗黒の' , '闇の' , 'いにしえの' , '漆黒の' , '光の', '天上の' , '最強の' , '永遠の' , '二次元の', '宇宙の' , '悪の' , '二子玉の' , '地獄の' , '呪いの', '全裸の', 'セクシーな', '深海の' , '究極の', '想像上の', '狂気の', '白馬の', '炎の');
        $name3 = array ('使徒' , '王' , '神', '鬼' , '覇者', '魔物' , '堕天使' , '竜' , 'お母さん' , '使者' , '鬼神' , 'ニート' , '民' , '住人' , '悪魔' , '獣' , 'おっさん' , '虫', 'ハンター', 'ドラゴン', 'クソムシ' , '河童', '狂人', 'サイエンティスト', '胎児');
